    ...
    <main className="landing-page">
      <section className="landing-page__banner">
        <p className="landing-page__banner-text">
          <img
            className="landing-page__banner-icon"
            src={bb8}
            alt="rolling type droid icon"
          />
          Here to help.
      ...
      <section className="landing-page__job-search">
        <form
          className="landing-page__job-form"
        ...
        >
          <section className="landing-page__job-form-section">
            ...
            <label className="landing-page__job-form-label">
              Job title, experience, or branch of the Empire
              <input
                className="landing-page__job-form-input"
                name="what"
                type="text"
        ...
        <p className="landing-page__posting-cta">
          <Link className="landing-page__posting-cta-link" to="/">
      ...
      <section className="landing-page__employee-cta">
        <h2 className="landing-page__employee-cta-heading">
          Help the Empire find Jedi
        </h2>
        <button className="landing-page__employee-cta-upload">
          Upload your hologram
        </button>
      </section>
    </main>
